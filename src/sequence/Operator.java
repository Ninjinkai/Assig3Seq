...
public class Operator {
	...
	public boolean activate(Crane crane) {
		...
		System.out.println("Operator " + this.operatorIDNumber + " is activating Crane " + crane.craneIDNumber + ".");
	...
	public void move(Crane crane, Warehouse warehouse) {
		...
		System.out.print("Operator " + this.operatorIDNumber + " is moving Crane " + crane.craneIDNumber +
	...
	public void move(Crane crane, Ship ship, Container container) {
		...
		System.out.print("Operator " + this.operatorIDNumber + " is moving Crane " + crane.craneIDNumber +
				" with Container " + container.containerIDNumber + " to Ship " + ship.shipIDNumber + "...");
	...
	public void pickup(Crane crane, Container container) {
		...
		System.out.print("Operator " + this.operatorIDNumber + " is using Crane " + crane.craneIDNumber +
	...
	public void deliver(Crane crane, Ship ship, Container container) {
		...
		System.out.print("Operator " + this.operatorIDNumber + " is using Crane " + crane.craneIDNumber +
				" to deliver Container " + container.containerIDNumber + " to Ship " + ship.shipIDNumber + "...");
